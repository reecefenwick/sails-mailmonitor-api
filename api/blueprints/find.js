...
module.exports = function (req, res) {
  ...
  var findQuery = _.reduce(_.intersection(populate, takeAliases(Model.associations)), populateAliases, Model.find().populate('history').where(where).limit(limit).skip(skip).sort(sort));
